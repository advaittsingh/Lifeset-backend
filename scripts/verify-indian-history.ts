...
async function verifyIndianHistory() {
  try {
    console.log('📚 Indian History Structure Verification\n');
    console.log('='.repeat(70));

    // Find Indian History category
    ...
    if (!category) {
      console.log('❌ Indian History category not found!');
      return;
    }
